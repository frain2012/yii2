			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="BaseMaterial[title]" class="form-control" datatype="*2-16" errormsg="名称范围在2~16位之间！" value="<?=$model->title;?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<img alt="" src="<?=$model->image;?>" style="height:40px;width: 40px;">
						<input type="file" name="BaseMaterial[image]" value="<?=$model->image;?>" class="form-control" datatype="*" errormsg="关键词范围在2~16位之间！">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<textarea rows="" cols="" class="form-control" name="BaseMaterial[description]"><?=$model->description;?></textarea>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<select class="form-control" name="BaseMaterial[type]" datatype="n" id="type">
							<option value="1" <?php if ($model->type==1){ echo  'selected="selected"';}?>>图文</option>
							<option value="2" <?php if ($model->type==2){ echo  'selected="selected"';}?>>外链</option>
							<option value="3" <?php if ($model->type==3){ echo  'selected="selected"';}?>>红包活动</option>
							<option value="4" <?php if ($model->type==4){ echo  'selected="selected"';}?>>预约活动</option>
						</select>
					</div>
				</div>
				<div class="form-group" id="ndetail">
	                ...
	                <div class="col-sm-9 col-xs-12">
	                	<textarea rows="" cols="" class="form-control" name="BaseMaterial[content]"><?=$model->content;?></textarea>
				...
				<div class="form-group" id="wlink" style="display:none;">
	                ...
	                <div class="col-sm-9 col-xs-12">
		                <input type="text" name="BaseMaterial[link]" value="<?=$model->link;?>" class="form-control" />
	                </div>
	            </div>
