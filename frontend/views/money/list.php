                ...
                <!--div class="alert alert-warning" role="alert">
                 ...
                 <div class="row-fluid" style="margin-bottom:10px;">
                        <div class="control-group" style="color:#929292;margin-top:10px;">
                           <a class="btn btn-info btn-large" style="margin-right:20px;" href="/money/create?wid=<?=$wid?>">添加</a>
                    	</div>
                </div>
						...
						<table class="table table-bordered table-hover">
							...
							<tr>
								...
								<td style="vertical-align:middle;">
                                 ...
                                 <td style="vertical-align:middle;">
										<a class="btn btn-default" href="/money/update?id=<?=$item->id?>&wid=<?=$wid?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                    </td>
                            </tr>
                            <?php }?>
                            <tr>
