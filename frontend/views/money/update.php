		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="key" class="form-control" value="<?=$model->key?>" datatype="*2-16" errormsg="关键词范围在2~16位之间！">
				...
				<div class="form-group">
	                ...
	                <div class="col-sm-9 col-xs-12">
	                	<div class="input-group">
		                	<input type="text" name="sdate" value="<?=$model->sdate?>" placeholder="请选择开始日期" readonly="readonly" class="datetimepicker form-control" style="padding-left:12px;">
		                	<span class="input-group-addon">至</span>
							<input type="text" name="edate" value="<?=$model->edate?>" placeholder="请选择结束日期" readonly="readonly" class="datetimepicker form-control" style="padding-left:12px;">
						</div>
	                </div>
	            </div>
	            <div class="form-group">
	                ...
	                <div class="col-sm-9 col-xs-12">
	                	<div class="input-group">
		                	<input type="text" name="stime" value="<?=$model->stime?>" placeholder="请选择开始时间" readonly="readonly" class="timePicker form-control" style="padding-left:12px;">
		                	<span class="input-group-addon">至</span>
							<input type="text" name="etime" value="<?=$model->etime?>" placeholder="请选择结束时间" readonly="readonly" class="timePicker form-control" style="padding-left:12px;">
						</div>
	                </div>
	            </div>
	            <script type="text/javascript">
	            $(function($) {
	            	$('.datetimepicker').datetimepicker({format:"Y-m-d H:i",timepicker:false});
	            ...
	            <div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<select class="form-control" name="isarea">
							<option value="0" <?php if ($model->isarea == 0) echo 'selected="selected"';?>>否</option>
							<option value="1" <?php if ($model->isarea == 1) echo 'selected="selected"';?>>是</option>
						</select>
					</div>
				</div>
				<div class="form-group">
						...
						<div class="row">
							<div class="col-xs-6">
								<select class="form-control" name="type">
									<option value="0" <?php if ($model->type == 0) echo 'selected="selected"';?>>总共</option>
									<option value="1" <?php if ($model->type == 1) echo 'selected="selected"';?>>每天</option>
									<option value="2" <?php if ($model->type == 2) echo 'selected="selected"';?>>每时</option>
								</select>
							</div>
							<div class="col-xs-6">
								<div class="input-group">
									<input type="text" name="num" value="<?=$model->num?>" class="form-control"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<div class="input-group">
		                	<input type="text" name="smoney" value="<?=$model->smoney?>" placeholder="最小金额" class="form-control" style="padding-left:12px;">
		                	<span class="input-group-addon">至</span>
							<input type="text" name="mmoney" value="<?=$model->mmoney?>" placeholder="最大金额" class="form-control" style="padding-left:12px;">
						</div>
