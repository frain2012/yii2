			...
			<div class="box-content">
				<form action="" method="post" class="form-horizontal form-validate"  enctype="multipart/form-data">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="City[name]" datatype="*2-100" errormsg="昵称至少2个字符,最多100个字符！" value="<?=$model->name?>"/>
						</div>
					</div>
					<div class="control-group">
						<label for="name" class="control-label"><span class="maroon">*</span>二维码：</label>
						<div class="controls">
							<img src="<?=$model->qrcode?>" style="height:60px;width:60px;">
							<input type="file" name="City[qrcode]"/>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="City[order]" datatype="n" value="<?=$model->order?>"/>
						</div>
					</div>
