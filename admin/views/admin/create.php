			...
			<div class="box-content">
				<form action="" method="post" class="form-horizontal form-validate">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="AdminForm[nickname]" datatype="s2-16" errormsg="名称至少2个字符,最多16个字符！"/>
						</div>
					</div>
					<div class="control-group">
						<label for="name" class="control-label"><span class="maroon">*</span>帐号：</label>
						<div class="controls">
							<input type="text" name="AdminForm[username]" ajaxurl="/admin/findusername" datatype="s4-16" errormsg="描述至少2个字符,最多16个字符！"/>
						</div>
					</div>
					<div class="control-group">
						<label for="name" class="control-label"><span class="maroon">*</span>密码：</label>
						<div class="controls">
							<input type="password" name="AdminForm[password]" datatype="s2-16" errormsg="描述至少2个字符,最多16个字符！"/>
						</div>
					</div>
					<div class="control-group">
						<label for="name" class="control-label"><span class="maroon">*</span>确认密码：</label>
						<div class="controls">
							<input type="password"  recheck="AdminForm[password]" datatype="s2-16" errormsg="密码不一致"/>
						</div>
					</div>
