...
<div class="breadcrumb">
    ...
    <span class="text-muted">活动客服信息</span>
</div>
...
<div class="app" style="">
    <div class="app-inner" style="">
        ...
        <div class="para-title"><h3>活动客服信息</h3></div>
        ...
        <div class="row" style="">
            ...
            <form class="form-horizontal" id="shop-home" style="">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">活动客服信息</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control"  name="kefu" value="<?php if(!is_null($data)){echo $data->kefu;} ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3" style="display: inline-block;">
                        ...
                        <span class="label label-warning ">请上传200x200px的客服微信二维码</span>
            ...
            function save()
            {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        {
                            alert(data.msg);
                            window.location.href='/setting/bottom'
                        }
                        else
                        {
